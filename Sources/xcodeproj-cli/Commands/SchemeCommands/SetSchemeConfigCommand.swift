...
struct SetSchemeConfigCommand: Command {
    ...
    init(arguments: ParsedArguments) throws {
        ...
        self.buildConfig = arguments.getFlag("build")
        self.runConfig = arguments.getFlag("run")
        self.testConfig = arguments.getFlag("test")
        self.profileConfig = arguments.getFlag("profile")
        self.analyzeConfig = arguments.getFlag("analyze")
        self.archiveConfig = arguments.getFlag("archive")
        self.verbose = arguments.boolFlags.contains("verbose")
        
        // Ensure at least one configuration is specified
        if buildConfig == nil && runConfig == nil && testConfig == nil &&
           profileConfig == nil && analyzeConfig == nil && archiveConfig == nil {
